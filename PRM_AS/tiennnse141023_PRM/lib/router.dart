...
import 'package:prm_as_tiennn8_se141023/screan/booking_fail/booking_fail_screan.dart';
import 'package:prm_as_tiennn8_se141023/screan/booking_success/booking_success_screan.dart';
...
final Map<String, WidgetBuilder> routers = {
  ...
  BookingFailScreen.routeName: (context) => BookingFailScreen(),
  BookingSuccessScreen.routeName: (context) => BookingSuccessScreen(),
};
